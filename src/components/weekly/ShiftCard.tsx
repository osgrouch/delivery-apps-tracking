...
function StatCell({ label, value, icon: Icon, sub }: StatCellProps) {
  return (
    <div className="flex flex-col gap-[3px] rounded-[7px] border border-white/5 bg-secondary/60 px-[10px] py-[5px]">
...
export function ShiftCard({ shift, color }: ShiftCardProps) {
  ...
  return (
    <div
      className="flex w-[323px] shrink-0 flex-col overflow-hidden rounded-[14px] border-2 bg-card shadow-[0_3px_20px_rgba(0,0,0,0.4)]"
